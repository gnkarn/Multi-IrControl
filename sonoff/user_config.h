...
// -- Project -------------------------------------
#define PROJECT                "Multi-IR"          // PROJECT is used as the default topic delimiter
...
#define FRIENDLY_NAME          "Multi_ir"          // [FriendlyName] Friendlyname up to 32 characters used by webpages and Alexa
...
#define TIME_STD_OFFSET        +180                // Offset from UTC in minutes (-780 to +780)
